    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 className="text-[5vw] m-0 font-light "> {t('heading')} </h2>
          <motion.div
            style={{ x }}
            className={cn(
              'absolute top-[calc(100%-75px)] ',
              isArabic ? 'right-[calc(100%-400px)]' : 'left-[calc(100%-400px)]'
            )}
          >
            <Link href={`/${locale}/contact`}>
              ...
              >
                <p className="m-0 text-lg font-light z-[2] relative ">
                  {t('action')}
                </p>
              </RoundedBtn>
            </Link>
