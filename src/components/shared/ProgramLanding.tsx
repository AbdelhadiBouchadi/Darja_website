    ...
    <>
      <section ref={sectionRef} data-scroll-section="" className="">
        ...
        <motion.div
          ...
          className="bg-description w-full min-h-screen relative py-8 mb-8 lg:mt-[350px] lg:mb-32 md:mb-16 2xl:my-[23rem]  flex flex-col lg:flex-row lg:items-center border-b-2"
